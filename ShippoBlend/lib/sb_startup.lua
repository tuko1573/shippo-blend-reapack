--[[
  sb_startup.lua
  Shippo Blend Plugins — REAPER起動時の自動送信を仕込む／外す。
...
M.BEGIN_MARK = "-- BEGIN ShippoBlend (managed; safe to delete)"
M.END_MARK = "-- END ShippoBlend"
...
-- 開発中の手置き   → "ShippoBlend"
-- ReaPack経由      → "Shippo Blend/ShippoBlend"
...
function M.block(subpath)
  ...
  rel = rel .. "ShippoBlend_SendNow.lua"
